...
[![Formula](https://img.shields.io/badge/nusic-0.2.1-green?style=flat-square)](Formula/nusic.rb)
...
|---------|-------------|---------|
| 🎵 **nusic** | Cross-platform terminal music player for local files | `0.2.1` |
...
Track the latest unreleased commits from the Nusic repo:
